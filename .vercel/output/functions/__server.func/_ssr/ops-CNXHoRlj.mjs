...
import { i as KPI_COPY } from "./ops-BbesVQD-.mjs";
...
import { i as getDashboard } from "./ops.functions-7TMTmNkW.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/ops-CNXHoRlj.js
...
function OpsDashboard() {
	...
	(0, import_react.useEffect)(() => {
		...
		if (!pin) return;
		getDashboard({ data: { pin } }).then(setData).catch((e) => setErr(e instanceof Error ? e.message : "Erro"));
	}, []);
