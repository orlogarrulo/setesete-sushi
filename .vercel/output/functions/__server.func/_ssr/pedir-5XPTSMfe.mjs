...
import { a as LINKEDIN, c as PAY_METHODS, d as WHATSAPP_DISPLAY, f as cn, i as INSTAGRAM, l as SITE, n as HOURS, p as formatKz, r as IBAN, s as MCX_NUMBER, t as EMAIL, u as WHATSAPP } from "./utils-DDxYvakE.mjs";
import { r as createOrder } from "./ops.functions-DmaAzKP6.mjs";
import { t as fileToReceipt } from "./receipt-file-CKrlpYiu.mjs";
import { n as Mark } from "./mark-BTZFlxUV.mjs";
import { a as productById, c as t, i as copy, l as useCart, r as Shell, u as useLang } from "./shell-CyyHlumO.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/pedir-5XPTSMfe.js
...
function buildOrderMessage(ticket) {
	...
	const extra = [];
	extra.push(lang === "pt" ? `Comprovativo: ${ticket.receiptName ?? "anexado na encomenda"}` : `Proof: ${ticket.receiptName ?? "attached to the order"}`);
	if (ticket.pay === "transfer") extra.push(`IBAN: ${IBAN}`);
	if (ticket.pay === "mcx") extra.push(lang === "pt" ? `Multicaixa Express: ${MCX_NUMBER} · ref. ${ticket.id}` : `Multicaixa Express: ${MCX_NUMBER} · ref. ${ticket.id}`);
	return [
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				ticket.trackToken ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: lang === "pt" ? "Ponto A → ponto B" : "Point A → point B"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					children: busy ? lang === "pt" ? "A gerar…" : "Creating…" : t(copy.pedir.send, lang)
				})
			]
		})]
	}) });
