...
import { c as t, i as copy, n as PRODUCTS, r as Shell, t as CATEGORIES, u as useLang } from "./shell-DsxHswG9.mjs";
import { n as showOpeningSoon } from "./hours-Bem0ew0F.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-bKkS5UGe.js
var import_jsx_runtime = require_jsx_runtime();
function OpeningBanner() {
	if (!showOpeningSoon()) return null;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "relative z-10 border-b border-rice/15 bg-nori/70 px-4 py-4 text-center text-rice backdrop-blur-sm sm:py-5",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "text-[11px] font-medium tracking-[0.32em] text-kaki-soft uppercase",
			children: "Abertura do serviço brevemente"
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "relative",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(OpeningBanner, {})
				}),
