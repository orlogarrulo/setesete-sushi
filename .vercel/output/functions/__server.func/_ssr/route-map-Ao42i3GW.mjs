...
function LegendDot({ letter, title, sub, align }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: align === "right" ? "text-right" : void 0,
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				className: "text-[10px] tracking-[0.2em] text-kaki-soft uppercase",
				children: [
					letter,
					" · ",
					letter === "A" ? "Partida" : "Destino"
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-1 max-w-40 truncate text-sm text-rice",
				children: title
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "max-w-40 truncate text-xs text-stone",
				children: sub
			})
		]
	});
