...
import { n as ZONES, u as zoneById } from "./geo-CSQz4fgL.mjs";
import { V as require_react, v as Link, x as require_jsx_runtime } from "../_libs/@tanstack/react-router+[...].mjs";
import { c as Minus, o as Printer, s as Plus } from "../_libs/lucide-react.mjs";
import { a as LINKEDIN, c as PAY_METHODS, d as WHATSAPP_DISPLAY, f as cn, i as INSTAGRAM, l as SITE, n as HOURS, p as formatKz, r as IBAN, s as MCX_NUMBER, t as EMAIL, u as WHATSAPP } from "./utils-CJy7FdrE.mjs";
import { r as createOrder, y as submitOrderReceipt } from "./ops.functions-DHvQhR2m.mjs";
import { t as fileToReceipt } from "./receipt-file-CKrlpYiu.mjs";
import { n as Mark } from "./mark-Byq4d7Oa.mjs";
import { a as productById, c as t, i as copy, l as useCart, r as Shell, u as useLang } from "./shell-DsxHswG9.mjs";
import { t as isHouseOpen } from "./hours-Bem0ew0F.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/pedir-Brqx6qf_.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function ClosedNotice({ compact, received }) {
	if (compact) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "rounded-xl border border-kaki/25 bg-kaki/5 px-4 py-4",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-[11px] tracking-[0.22em] text-kaki uppercase",
				children: "Estamos fechados"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Podes deixar a encomenda. Contactamos-te na abertura, pela ordem de chegada."
			})
		]
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "overflow-hidden rounded-xl bg-nori text-rice shadow-[var(--shadow-border)]",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "px-6 py-8 text-center sm:px-8",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-[11px] tracking-[0.28em] text-kaki-soft uppercase",
					children: "Sete Sete · Luanda"
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-3 text-sm tracking-[0.16em] text-rice/70 uppercase",
					children: "Todos os dias · 12h – 22h"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mx-auto mt-5 max-w-md text-sm leading-relaxed text-rice/75",
					children: received ? "Recebemos a tua encomenda. Contactamos-te durante o horário de abertura, seguindo a ordem das encomendas." : "Podes deixar o pedido. Confirmamos na abertura, pela ordem das encomendas."
				})
			]
		})
	});
...
function buildOrderMessage(ticket) {
	...
	if (ticket.afterHours) {
		extra.push(lang === "pt" ? "*Encomenda a ser confirmada — fora do horário*" : "*Order pending confirmation — outside opening hours*");
		extra.push(lang === "pt" ? "Contactamos-te na abertura (12h–22h), pela ordem das encomendas." : "We will contact you at opening (12:00–22:00), in order of arrival.");
	}
	if (ticket.pay === "transfer") extra.push(`IBAN: ${IBAN}`);
	if (ticket.pay === "mcx") extra.push(lang === "pt" ? `Multicaixa Express: ${MCX_NUMBER} · referência da fatura ${ticket.id}` : `Multicaixa Express: ${MCX_NUMBER} · invoice reference ${ticket.id}`);
	if (ticket.receiptName) extra.push(lang === "pt" ? `Comprovativo: ${ticket.receiptName}` : `Proof: ${ticket.receiptName}`);
	return [
		...
		ticket.trackUrl ? lang === "pt" ? `Seguir encomenda: ${ticket.trackUrl}` : `Track order: ${ticket.trackUrl}` : null
	].filter((x) => x !== null).join("\n");
}
function clientWhatsAppDigits(phone) {
...
function buildWhatsAppUrl(ticket) {
	return `https://wa.me/${clientWhatsAppDigits(ticket.phone) || "244945407841"}?text=${encodeURIComponent(buildOrderMessage(ticket))}`;
}
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					ticket.receiptName ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
function PedirPage() {
	...
	const [proofOk, setProofOk] = (0, import_react.useState)(false);
	const waRef = (0, import_react.useRef)(null);
	const closed = !isHouseOpen();
	const empty = lines.length === 0;
	const zoneName = zoneById(zone)?.name ?? zone;
	const needsProof = pay !== "cash";
	function openWhatsApp(next) {
	...
	async function onSubmit(e) {
		...
		try {
			...
			setFormError(err instanceof Error ? err.message : lang === "pt" ? "Fatura gerada. O seguimento pode falhar — confirma no WhatsApp." : "Invoice created. Tracking may fail — confirm on WhatsApp.");
		} finally {
			setBusy(false);
		}
		openWhatsApp(next);
	...
	async function onSendProof() {
		...
		try {
			...
			await submitOrderReceipt({ data: {
				token: ticket.trackToken,
				receipt
			} });
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Shell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				ticket ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-4 max-w-md text-sm leading-relaxed text-stone",
					children: t(copy.pedir.sentBody, lang)
				}) : null,
				closed && !ticket ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-8",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ClosedNotice, { compact: true })
				}) : null,
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
								...
								className: "mt-1",
								children: closed ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "font-medium text-kaki",
									children: "Estamos fechados. "
								}), t(copy.pedir.hours, lang)] }) : t(copy.pedir.hours, lang)
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "border-t border-ink/8 pt-4",
			...
			className: "space-y-4",
			children: [
				ticket.afterHours ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ClosedNotice, { received: true }) : null,
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TicketSheet, { ticket }),
				ticket.pay !== "cash" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "print:hidden rounded-xl bg-rice-warm p-5 shadow-[var(--shadow-border)]",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-[11px] tracking-[0.18em] text-kaki uppercase",
							children: "Referência de pagamento"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						ticket.pay === "mcx" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							children: ["Multicaixa Express · ", MCX_NUMBER]
						}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "mt-2 break-all text-sm text-stone",
							children: ["IBAN · ", IBAN]
						}),
						proofOk ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-4 text-sm text-kaki",
							children: "Comprovativo recebido."
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									children: "Enviar comprovativo"
								})
							]
						})
					]
				}) : null,
				ticket.trackToken ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "print:hidden rounded-xl bg-rice-warm p-5 shadow-[var(--shadow-border)]",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-[11px] tracking-[0.18em] text-kaki uppercase",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-2 text-sm text-stone",
							children: t(copy.pedir.trackHint, lang)
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/seguir/$token",
							...
							children: t(copy.pedir.trackCta, lang)
						})
					]
				}) : null,
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
					...
					children: t(copy.pedir.finish, lang)
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					type: "button",
					onClick: startNew,
				...
				formError ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "print:hidden text-sm text-kaki",
					children: formError
				}) : null,
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
					className: "mt-5 block text-sm font-medium",
					children: [t(copy.pedir.area, lang), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", {
						required: true,
						value: zone,
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("legend", {
						...
						children: Object.keys(PAY_METHODS).map((key) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								...
								key === "mcx" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "mt-1 block font-mono text-sm tracking-wide text-ink",
									children: MCX_NUMBER
								}) : null,
								key === "transfer" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "mt-1 block break-all font-mono text-xs tracking-wide text-ink",
									children: IBAN
								}) : null,
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					children: busy ? lang === "pt" ? "A gerar fatura…" : "Creating invoice…" : t(copy.pedir.send, lang)
				}),
				needsProof ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-3 text-xs leading-relaxed text-stone",
					children: "Primeiro geras a fatura (fica com a referência). Depois pagas e anexas o comprovativo."
				}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-3 text-xs leading-relaxed text-stone",
					children: "Dinheiro: sem comprovativo. Pagas na entrega, contra a fatura."
				})
			]
		})]
	}) });
