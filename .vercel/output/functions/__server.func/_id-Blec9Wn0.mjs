...
import { a as STATUS_META, c as nextStatus, r as FLOW } from "./_ssr/ops-CJMdWyyN.mjs";
...
import { g as Check, m as Copy } from "./_libs/lucide-react.mjs";
import { n as Route } from "./_ssr/router-An-1XikS.mjs";
import { f as cn, p as formatKz } from "./_ssr/utils-CJy7FdrE.mjs";
import { t as ExportBar } from "./_ssr/export-bar-B6Mn9Tfh.mjs";
import { _ as setOrderStatus, c as getReceipt, n as attachReceipt, s as getOrder, x as verifyPayment } from "./_ssr/ops.functions-DHvQhR2m.mjs";
import { t as RouteMap } from "./_ssr/route-map-CWSqgOkh.mjs";
import { t as fileToReceipt } from "./_ssr/receipt-file-CKrlpYiu.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_id-Blec9Wn0.js
...
function OrderDetail() {
	...
	const [proofs, setProofs] = (0, import_react.useState)([]);
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RouteMap, {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					className: "mt-8 rounded-xl bg-rice/5 p-4",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "text-[11px] tracking-[0.16em] text-stone uppercase",
							children: ["Comprovativo · ", order.id]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "mt-1 text-sm text-stone",
							children: ["Ligado ao WhatsApp ", order.phone]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-2 text-xs tracking-[0.12em] uppercase",
							children: order.payVerified ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-kaki-soft",
								children: "Pagamento verificado"
							}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-kaki",
								children: "Aguardando verificação"
							})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: proofs.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-sm text-stone",
								children: "Ainda sem ficheiro nesta ficha."
							}) : proofs.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("figure", {
								className: "overflow-hidden rounded-lg bg-nori",
								children: [p.mime.startsWith("image/") ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
									...
									className: "px-3 py-2 text-xs text-stone",
									children: [
										p.filename,
										" · ",
										p.phone
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								...
								className: "inline-flex min-h-11 cursor-pointer items-center rounded-full border border-rice/15 px-4 text-xs font-semibold tracking-[0.12em] uppercase",
								children: ["Anexar outro", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
									type: "file",
									...
									onChange: (e) => {
										...
										if (!f) return;
										setBusy(true);
										fileToReceipt(f).then((receipt) => attachReceipt({ data: {
											orderId: order.id,
											receipt
										} })).then(() => load()).finally(() => setBusy(false));
									}
